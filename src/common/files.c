...
static void setup_base_paths(void)
{
    ...
    add_temp_game_dir(FS_PATH_BASE | FS_PATH_GAME, "%s/."BASEGAME, sys_basedir->string);
...
static void setup_game_paths(void)
{
    ...
    if (fs_game->string[0]) {
        ...
        if (sys_homedir->string[0]) {
            ...
            add_temp_game_dir(FS_PATH_BASE, "%s/."BASEGAME, sys_homedir->string);
        ...
        if (sys_homedir->string[0]) {
            ...
            add_temp_game_dir(FS_PATH_BASE | FS_PATH_GAME,
                              "%s/."BASEGAME, sys_homedir->string);
        }
...
static void fs_game_changed(cvar_t *self)
{
    ...
    if (!fs_base_searchpaths) {
		...
		{
			Com_Errorf(ERR_FATAL, "No game data files detected. Please make sure that there are .pk3 files"
