...
#define LIST_IMAGES \
	...
	IMG_DO(POST_PROCESS_INPUT,        25, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_TAA,       IMG_HEIGHT_TAA ) \
...
#define BINDING_OFFSET_VISUAL_PHYSICAL_SKY (BINDING_OFFSET_PHYSICAL_SKY_IMG + 1)
#define BINDING_OFFSET_VISUAL_PHYSICAL_SKY_IMG (BINDING_OFFSET_VISUAL_PHYSICAL_SKY + 1)
#define BINDING_OFFSET_SKY_TRANSMITTANCE (BINDING_OFFSET_VISUAL_PHYSICAL_SKY_IMG + 1)
...
) uniform samplerCube TEX_VISUAL_PHYSICAL_SKY;

layout(
	set = GLOBAL_TEXTURES_DESC_SET_IDX,
	binding = BINDING_OFFSET_VISUAL_PHYSICAL_SKY_IMG,
	rgba16f
) uniform imageCube IMG_VISUAL_PHYSICAL_SKY;
