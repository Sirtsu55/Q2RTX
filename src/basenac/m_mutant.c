...
void mutant_step(edict_t *self)
{
    ...
    n = (Q_rand() + 1) % 3;
    if (n == 0)
        gi.sound(self, CHAN_VOICE, sound_step1, 1, ATTN_NORM);
    else if (n == 1)
        gi.sound(self, CHAN_VOICE, sound_step2, 1, ATTN_NORM);
    else
        gi.sound(self, CHAN_VOICE, sound_step3, 1, ATTN_NORM);
}
...
{
    gi.sound(self, CHAN_VOICE, sound_swing, 1, ATTN_NORM);
}
...
void mutant_hit_left(edict_t *self)
{
    ...
    if (fire_hit(self, aim, (10 + (Q_rand() % 5)), 100))
        gi.sound(self, CHAN_WEAPON, sound_hit, 1, ATTN_NORM);
    else
        gi.sound(self, CHAN_WEAPON, sound_swing, 1, ATTN_NORM);
}
...
void mutant_hit_right(edict_t *self)
{
    ...
    if (fire_hit(self, aim, (10 + (Q_rand() % 5)), 100))
        gi.sound(self, CHAN_WEAPON, sound_hit2, 1, ATTN_NORM);
    else
        gi.sound(self, CHAN_WEAPON, sound_swing, 1, ATTN_NORM);
}
...
{
    if (self->groundentity) {
        gi.sound(self, CHAN_WEAPON, sound_thud, 1, ATTN_NORM);
