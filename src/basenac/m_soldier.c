...
void soldier_cock(edict_t *self)
{
    if (self->s.frame == FRAME_stand322)
        gi.sound(self, CHAN_WEAPON, sound_cock, 1, ATTN_IDLE);
    else
        gi.sound(self, CHAN_WEAPON, sound_cock, 1, ATTN_NORM);
}
...
void soldier_pain(edict_t *self, edict_t *other, float kick, int damage)
{
    ...
    n = self->s.skinnum | 1;
    if (n == 1)
        gi.sound(self, CHAN_VOICE, sound_pain_light, 1, ATTN_NORM);
    else if (n == 3)
        gi.sound(self, CHAN_VOICE, sound_pain, 1, ATTN_NORM);
    else
        gi.sound(self, CHAN_VOICE, sound_pain_ss, 1, ATTN_NORM);
...
{
    if (random() < 0.5f)
        gi.sound(self, CHAN_VOICE, sound_sight1, 1, ATTN_NORM);
    else
        gi.sound(self, CHAN_VOICE, sound_sight2, 1, ATTN_NORM);
...
// regular death
    ...
    if (self->s.skinnum == 1)
        gi.sound(self, CHAN_VOICE, sound_death_light, 1, ATTN_NORM);
    else if (self->s.skinnum == 3)
        gi.sound(self, CHAN_VOICE, sound_death, 1, ATTN_NORM);
    else // (self->s.skinnum == 5)
        gi.sound(self, CHAN_VOICE, sound_death_ss, 1, ATTN_NORM);
