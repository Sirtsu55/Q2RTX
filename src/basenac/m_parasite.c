...
{
    gi.sound(self, CHAN_WEAPON, sound_launch, 1, ATTN_NORM);
}

void parasite_reel_in(edict_t *self)
{
    gi.sound(self, CHAN_WEAPON, sound_reelin, 1, ATTN_NORM);
}

void parasite_sight(edict_t *self, edict_t *other)
{
    gi.sound(self, CHAN_WEAPON, sound_sight, 1, ATTN_NORM);
}

void parasite_tap(edict_t *self)
{
    gi.sound(self, CHAN_WEAPON, sound_tap, 1, ATTN_IDLE);
}

void parasite_scratch(edict_t *self)
{
    gi.sound(self, CHAN_WEAPON, sound_scratch, 1, ATTN_IDLE);
}

void parasite_search(edict_t *self)
{
    gi.sound(self, CHAN_WEAPON, sound_search, 1, ATTN_IDLE);
}
...
void parasite_drain_attack(edict_t *self)
{
    ...
    if (self->s.frame == FRAME_drain03) {
        damage = 5;
        gi.sound(self->enemy, CHAN_AUTO, sound_impact, 1, ATTN_NORM);
    } else {
