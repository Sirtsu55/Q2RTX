    ...
    for (pnum = 0; pnum < cl.frame.numEntities; pnum++) {
        ...
        if (effects & ~EF_ROTATE) {
            if (effects & EF_ROCKET) {
                ...
                V_AddLightEx(origin, 100.f, 1.40f * brightness, 0.7f * brightness, 0.2f * brightness, 0.5f);
            }
                ...
                V_AddLightEx(origin, 25.f, 1.8f * brightness, 0.7f * brightness, 0.2f * brightness, 4.5f);
