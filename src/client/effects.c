...
void CL_SetLightStyle(int index, const char *s)
{
    ...
    if (ls->length > MAX_QPATH) {
        Com_Errorf(ERR_DROP, "%s: oversize style", __func__);
    }
...
void CL_MuzzleFlash(void)
{
    ...
    case MZ_MACHINEGUN:
        VectorSet(dl->color, 1, 1, 0);
        Q_snprintf(soundname, sizeof(soundname), "weapons/nailg/nailg_fire.wav", (Q_rand() % 5) + 1);
...
//  case MZ2_CARRIER_ROCKET_4:
    ...
    case MZ2_MAKRON_BFG:
        ...
        //S_StartSound (NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("makron/bfg_fire.wav"), 1, ATTN_NORM, 0, 0);
        break;
    ...
    case MZ2_JORG_MACHINEGUN_L6:
        ...
        CL_ParticleEffect(origin, forward, 0, 40);
        CL_SmokeAndFlash(origin);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("boss3/xfire.wav"), 1, ATTN_NORM, 0, 0);
        break;
